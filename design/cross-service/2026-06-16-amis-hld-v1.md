...
**Date**: 2026-06-16  
**Status**: Final HLD  
**Related Documents**: [AMIS Platform Architecture v1.0](./2026-06-16-amis-platform-v1.md)  
...
5. **Mandatory Gate 0**: Dependency health blocking with no overrides
6. **Mandatory Regime Governance**: VIX, Volatility, Market Structure, HTF Alignment required
...
**Registry Service**
- Immutable artifact registry (FeatureSchema, LabelVersion, Dataset, ModelArtifact, ResearchAsset)
...
**Artifact Lineage**
- Parent-child graph for all artifacts
...
**Related Architecture Document**: [AMIS Platform Architecture v1.0](./2026-06-16-amis-platform-v1.md)  
