...
|----------|------------------|--------------|--------|
| ~~Paper Broker Service HLD~~ | `2026-04-04-paper-broker-service-hld-v1.md` | ~~`paper-broker-service/docs/Paper_Broker_Service_HLD_v1.md`~~ | ❌ Removed (2026-05-16 - use CLAUDE.md instead) |
